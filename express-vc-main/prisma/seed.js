...
// foreignKey is in the second table
const oneToMany = ['Rent:RentItemColor', 'Rent:RentImges', 'CouponType:Coupon','DiscountType:Coupon', 'ActivityCategory:Activity', 'ActivityGenre:Activity', 'Activity:ActivityLineup', 'Activity:ActivityArticle','Activity:ActivityTicketType']
